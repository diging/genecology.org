...
urlpatterns = [
    ...
    url(r'^concepts/places/$', blog_views.people, name='places'),
    url(r'^concepts/institutions/$', blog_views.people, name='institutions'),
    url(r'^concepts/organisms/$', blog_views.people, name='organisms'),
